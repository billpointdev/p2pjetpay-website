...
const sections = [
  {
    ...
    content: `Welcome to jetpayX ("Company," "we," "our," "us")! jetpayX ("us," "we," or "our") operates this Service. 
  ...
  },
  {
    title: "2. Definitions",
    content: [
      { term: "SERVICE", definition: "means the website or app operated by jetpayX." },
  ...
  {
    title: "5. Use of Data",
    content: "jetpayX uses the collected data for various purposes, such as to provide and maintain our Service and to notify you about changes to it."
  },
  {
      ...
      <div className="container mx-auto py-8 px-4 sm:px-6 lg:px-8 mt-12">
        <Card className="w-full max-w-4xl mx-auto">
          <CardHeader>
            ...
            <p className="text-sm text-muted-foreground text-center mt-2">Last updated: 2025-01-09</p>
          </CardHeader>
          <CardContent>
